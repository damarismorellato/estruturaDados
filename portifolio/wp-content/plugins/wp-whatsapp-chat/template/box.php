      ...
      <div class="qlwapp-box">
        ...
        <div class="qlwapp-body">
          <?php if (isset($qlwapp['contacts'][0])): ?>
            <a class="qlwapp-account" data-action="open" data-phone="<?php echo esc_attr($qlwapp['contacts'][0]['phone']); ?>" data-message="<?php echo esc_html($qlwapp['user']['message']); ?>" href="#" target="_blank">
